  ...
  return (
    <Container>
      <Row className="d-flex justify-content-between">
        <Col
          className="options d-grid gap-3 mt-3"
          style={{
            height: "689px",
            width: "200px",
            overflowY: "scroll",
          ...
          >
            <Card
              style={{
                width: "30rem",
                border:
                  selectedOption === "option1" ? "1px solid #7126B5BF" : "none",
                boxShadow:
          ...
          >
            <Card
              style={{
                width: "30rem",
                border:
                  selectedOption === "option2" ? "1px solid #7126B5BF" : "none",
          ...
          >
            <Card
              style={{
                width: "30rem",
                border:
                  selectedOption === "option3" ? "1px solid #7126B5BF" : "none",
                boxShadow:
                  "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)",
              }}
              onClick={toggleDetails}
